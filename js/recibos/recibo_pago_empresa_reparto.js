...
function buildOrderStatusEmailCanceled(periodo) {
                                                                ...
                                                                <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                    ...
                                                                    <p style="padding-top: 4px;">
                                                                        <span style="font-size: 20px; line-height: 0px; color: #3AD080; font-family: Mulish, sans-serif;">
                                                                            ${agregaCerosPrecio(periodo.total)}
                                                                        </span>
                                                                    </p>
                                                            ...
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 40px;font-family:'Mulish',sans-serif;" align="left">
                                                                ...
                                                                <table style="width: 100%;">
                                                                    ...
                                                                    <tr style="height: 35px;">
                                                                        ...
                                                                        <td style="width: 50%; text-align: right;">
                                                                            <span><b>${periodo.transfer.order_id}</b></span>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr style="height: 35px;">
                                                                        ...
                                                                        <td style="width: 50%; text-align: right;">
                                                                            <span>${getDayFromTimestamp(periodo.fechaInicial)}${getTimestampToDate(periodo.fechaFinal)}</span>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr style="height: 35px;">
                                                                        ...
                                                                        <td style="width: 50%; text-align: right;">
                                                                            <span>${getTimestampToDate(periodo.transfer.creation_date)}</span>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr style="height: 35px;">
                                                                        ...
                                                                        <td style="width: 50%; text-align: right;">
                                                                            <span>${cutCLABE(periodo.transfer.bank_account.clabe)}</span>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr style="height: 35px;">
                                                                        ...
                                                                        <td style="width: 50%; text-align: right;">
                                                                            <span>${getTimestampToDate(periodo.transfer.operation_date)}</span>
                                                                        </td>
                                                                    </tr>
                                                                ...
                                                                <table style="width: 100%;">
                                                                    ...
                                                                    <tr style="height: 35px;">
                                                                        ...
                                                                        <!-- Cantidad de pedidos -->
                                                                        <td style="width: 50%; text-align: right;">
                                                                            <span>${periodo.entregas.length}</span>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr style="height: 35px;">
                                                                        <td style="width: 50%; text-align: left;">
                                                                            <span style="font-size: 18px;">Propinas</span>
                                                                        </td>

                                                                        <!-- Total de propinas -->
                                                                        <td style="width: 50%; text-align: right;">
                                                                            <span>${getTotalPropinas(periodo.entregas)}</span>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr style="height: 35px;">
                                                                        ...
                                                                        <!-- Total bruto - total -->
                                                                        <td style="width: 50%; text-align: right;">
                                                                            <span>- ${getComision(periodo.ganancia, periodo.gananciaBruta)}</span>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr style="height: 35px;">
                                                                        <td style="width: 50%; text-align: left;">
                                                                            <span style="font-size: 18px;">IVA</span>
                                                                        </td>

                                                                        <!-- Total bruto - total -->
                                                                        <td style="width: 50%; text-align: right;">
                                                                            <span>- ${agregaCerosPrecio(periodo.iva)}</span>
                                                                        </td>
                                                                    </tr>
                                                            ...
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 40px;font-family:'Mulish',sans-serif;" align="left">
                                                                ...
                                                                <table style="width: 100%;">
                                                                    ...
                                                                    <tr style="height: 35px;">
                                                                        ...
                                                                        <!-- Total pagado -->
                                                                        <td style="width: 50%; text-align: right;">
                                                                            <span style="font-size: 20px;"><b>${agregaCerosPrecio(periodo.transfer.amount)}</b></span>
                                                                        </td>
                                                                    </tr>
                                                        ...
                                                        <tr>
                                                            <td style="overflow-wrap:break-word;word-break:break-word;font-family:'Mulish',sans-serif;" align="middle">
                                                                ...
                                                                <table style="width: 100%;">
                                                                    ...
                                                                    <tr>
                                                                        <td style="width: 100%;">
                                                                            <img src="https://firebasestorage.googleapis.com/v0/b/volada-fire-edd42.appspot.com/o/imagenes-correos%2Fbanner_recibo_empresa_reparto.png?alt=media&token=c4d0ee05-afd5-4498-af98-6224805219b2" alt="" width="600">
                                                                        </td>
                                                                    </tr>
                                                            ...
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 40px 30px;font-family:'Mulish',sans-serif;"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 100%;">
                                                                    <span style="font-size: 12px; line-height: 0px; color: #303133; font-family: Mulish, sans-serif;">
                                                                        ...
                                                                        <br>
                                                                        Para consultas o aclaraciones por favor escribenos a <a href="mailto:repartidor@volada.app"
                                                                            style="color:#039AE4;">repartidor@volada.app</a>.
                                                                    </span>
                                                                </p>
...
function getTotalPropinas(entregas) {
    let html = ``;
    ...
    for (let i = 0; i < entregas.length; i++) {
        if (entregas.propina) {
            propinas = propinas + entregas.propina;
        }
    }

    html = `${agregaCerosPrecio(propinas)}`;
